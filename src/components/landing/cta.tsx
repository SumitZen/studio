        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary via-purple-500 to-accent p-12 shadow-lg">
          <div className="relative z-10 text-center text-primary-foreground">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-lg text-primary-foreground/90">
              Join CrediKey today and take the first step towards a more organized and verifiable professional life. Sign up now and experience the future of credential management.
            </p>
            <div className="mt-10">
              <Button
                size="lg"
