        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
          <div>
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              At CrediKey, we are committed to protecting your sensitive information with state-of-the-art security measures. Your credentials are safe, secure, and always under your control.
            </p>
